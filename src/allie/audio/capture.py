...
from allie.audio.vad import PREROLL_SECONDS, Endpoint, Segmenter
from allie.audio.wake import WakeDetector
from allie.stt.base import SAMPLE_RATE, Audio, dbfs, to_pcm16
...
class MicrophoneInfo:
    """One line of PortAudio's table, as `allie mic` offers it and as
...
class SystemMicrophone:
    ...
    def _open_stream(self, sounddevice: Any) -> Any:
        ...
        # Which device this is, in the line `allie mic` would store for
