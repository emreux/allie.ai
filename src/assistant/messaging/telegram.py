...
slice `live-assistant telegram login` uses once. `TelethonClient` is both, and
...
# The last link of the chain of section 3.12 for what `live-assistant telegram
...
NOT_LOGGED_IN = "Telegram is not logged in: run 'live-assistant telegram login'."
...
# --------------------------------------------------------------------------
# Logging in: `live-assistant telegram login`
# --------------------------------------------------------------------------
