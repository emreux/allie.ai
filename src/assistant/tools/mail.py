...
**Setting up is one command.** `live-assistant mail login` asks for the server
...
# The last link of the chain of section 3.12 for what `live-assistant mail
...
# gate's answers.
NOT_SET_UP = (
    "Mail is not set up. Tell the user to run 'live-assistant mail login' in a terminal, "
