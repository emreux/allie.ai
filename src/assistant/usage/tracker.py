...
answered. `live-assistant cost` adds the rows up; the two spending limits of
...
the prices this build knows, and `%APPDATA%\\live-assistant\\pricing.toml`, if the
...
that reads as free, and `live-assistant cost` says the price is unknown instead.
